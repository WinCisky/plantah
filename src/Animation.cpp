    ...
    , m_speed (speed)
{
    ...
    m_sprite.setTextureRect(sf::IntRect(sf::Vector2i(std::floor(m_currentFrame) * m_size.x, 0), sf::Vector2i(m_size.x, m_size.y)));
}

// updates the animation to show the next fram, depending on its speed
